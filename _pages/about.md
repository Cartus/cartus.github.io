...
**I actively seek strong and motivated MPhil/PhD students to join our group! Feel free to email me if you are interested. More details can be found in [Prospective Students and Visitors](https://cartus.github.io/news/announcement_2/)/[中文版](https://zhuanlan.zhihu.com/p/9909735774).**

I am interested in natural language processing and machine learning, with a particular focus on large language models (LLMs). My research investigates the fundamental questions of **LLMs and Agentic AI** to enable rigorous reasoning, robust knowledge integration,  efficient algorithms, and generalizable models that achieve superior reliability and scalability. 
